mediate_bart <- function(fit_y, fit_m, design_y, design_m, 
                         trt_name, med_name, 
                         med_pred_name = NULL,
                         max_iter = NULL, 
                         iters = NULL,
  ...
  # if(!is.null(med_pred_name)) {
  #   design_y_00[[med_pred_name]] <- predict(fit_m, design_m_0)
  #   design_y_01[[med_pred_name]] <- predict(fit_m, design_m_1)
  #   design_y_10[[med_pred_name]] <- predict(fit_m, design_m_0)
  #   design_y_11[[med_pred_name]] <- predict(fit_m, design_m_1)
  # }
